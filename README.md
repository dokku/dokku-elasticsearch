...
Official elasticsearch plugin for dokku. Currently defaults to installing [elasticsearch 7.17.10](https://hub.docker.com/_/elasticsearch/).
...
You can also specify the image and image version to use for the service. It _must_ be compatible with the elasticsearch image.
